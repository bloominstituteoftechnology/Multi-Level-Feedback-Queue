...
class Queue {
  ...
  enqueue(process) {
    ...
    return process.setParentQueue(this);
  ...
  doCPUWork(time) {
    ...
    p.executeProcess(time);
    this.manageTimeSlice(p, time);
  }
  ...
  emitInterrupt(source, interrupt) {
    const i = this.processes.findIndex(process => process === source);
