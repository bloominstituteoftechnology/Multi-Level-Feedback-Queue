...
class Queue {
    ...
    dequeue() {
        const process = this.processes.splice(0,1)[0]; 
        return process;
    }
    ...
    manageTimeSlice(currentProcess, time) {
        if (currentProcess.isStateChanged()) {
            ...
            if (this.quantumClock > this.quantum) {
                ...
                if (!process.isFinished()) this.scheduler.handleInterrupt(this, process, 'LOWER_PRIORITY');
            }
        }
    }
    ...
    emitInterrupt(source, interrupt) {
        ...
        if (interrupt === 'PROCESS_BLOCKED') this.scheduler.handleInterrupt(this, process, 'PROCESS_BLOCKED');
        if (interrupt === 'PROCESS_READY') this.scheduler.handleInterrupt(this, process, 'PROCESS_READY');
    }
}
