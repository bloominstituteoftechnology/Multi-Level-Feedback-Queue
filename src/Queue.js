...
class Queue {
    ...
    isEmpty() {
      return this.processes.length > 0 ? false : true
    }
    ...
    manageTimeSlice(currentProcess, time) {
      ...
      if (this.quantumClock > this.quantum) {
        ...
        if (!process.isFinished()) this.scheduler.emitInterrupt(this, process, SchedulerInterrupt.LOWER_PRIORITY)
      }
    }
    ...
    emitInterrupt(source, interrupt) {
      const indexed = this.processes.indexOf(source)
      this.processes.splice(indexed, 1)
      ...
      switch(interrupt) {
        ...
        default: {
          console.log('Error no process emitted!')
          break
        }
      }
    }
